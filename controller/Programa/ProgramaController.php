...
class ProgramaController {
    ...
    public function postInsert(){
        ...
        $sql = "INSERT INTO t_programa VALUES($id, $lin_tec_cod,1, '$nom_prog', '' , '$desc_prog', '', '','')";
    ...
    public function consult()
    {
        ...
        $sql = "SELECT tp.id_prog, tlt.	lin_tec_desc, tp.nom_prog, tp.desc_prog  FROM t_programa tp, t_lineatecnologica tlt  WHERE tlt.lin_tec_cod =tp.lin_tec_cod ";
