			...
			<div class="row">
				...
				<div class="col-lg-3 footer_col">
					...
					<div class="footer_column_content">
						<ul>
							<li class="footer_list_item"><a href="http://oferta.senasofiaplus.edu.co/sofia-oferta/">Sofia plus</a></li>
							<li class="footer_list_item"><a href="https://sena.territorio.la/index.php?login=true">Territorium</a></li>
							<li class="footer_list_item"><a href="https://sena.territorio.la/cms/index.php">SENA</a></li>
		...
		<div class="footer_bar d-flex flex-column flex-sm-row align-items-center">
			<div class="footer_copyright">
				<span>
					...
					</script> Servicio Nacional de Aprendizaje SENA
					<!-- Link back to Colorlib can"t be removed. Template is licensed under CC BY 3.0. -->
				</span>
			</div>
		</div>
