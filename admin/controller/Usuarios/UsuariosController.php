<?php
    ...
    class UsuariosController{
        ...
        public function getUpdateModal(){
            ...
            $sql="SELECT u.usu_nombre, u.usu_nombre2, u.usu_id, u.usu_apellido, td.nom_tipo_doc, r.desc_rol,td.nom_tipo_doc, u.cod_tipo_doc, u.usu_ndocumento, u.usu_correo, u.cod_rol FROM t_usuario u, t_tipodocumento td, t_rol r WHERE usu_id=$id AND td.cod_tipo_doc=u.cod_tipo_doc AND r.cod_rol=u.cod_rol ";
            $usuarios=$obj->consult($sql);
        ...
        public function postUpdate(){
            ...
            if($validar){
                ...
                if($ndoc==$datos['usu_ndocumento'] && $id=$datos['usu_id']){
                    $sql="UPDATE t_usuario SET usu_nombre='$nombre1',usu_nombre2='$nombre2',usu_apellido='$apellido',cod_tipo_doc=$tipodoc, cod_rol=$rol WHERE usu_id=$id";
