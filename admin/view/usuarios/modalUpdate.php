    ...
    <form action="<?php echo getUrl("Usuarios","Usuarios","postUpdate")?>" method="post" enctype="multipart/form-data">
        ...
        <div class="row">
            ...
            <div class="col-md-6 form-group">
                ...
                <select  required="required" class="form-control" name="cod_tipo_doc">
        ...
        <div class="col-md-6 form-group">
            ...
            <div class="col-md-6 form-group">
                ...
                <input required="required" type="number"  name="usu_ndocumento" class="form-control" value="<?php echo $usu['usu_ndocumento'];?>">
            </div>
        </div>
